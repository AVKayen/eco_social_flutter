...
class HttpActivityRepository implements ActivityRepository {
  ...
  Future<List<Activity>> getUserActivities(
    ...
    return List<Activity>.from((response as List).map((e) => Activity.fromJson(e)));
  }
  ...
  @override
  Future<Activity> createActivity({required Activity activity}) async {
    final response = await Request.post('/activities/activity', activity.toJson());
    return Activity.fromJson(response);
  }

  @override
  Future<Activity> updateActivity({required Activity activity}) async {
    final response = await Request.put('/activities/${activity.id}', activity.toJson());
    return Activity.fromJson(response);
  }
